...
0.55). It replaces FULL-v1, which is kept in `runs/`: if M-v5 scores below 0.96 on the
leaderboard, copy FULL-v1 back.
...
| **M-v5** | `NORM-v2__BLK-v4b@20-tlu40__FEAT-v3__MATCH-v6` | test-like | 0.9852 | pending | `9c66b92887f0eced0291bc42f78d8b2f` |
