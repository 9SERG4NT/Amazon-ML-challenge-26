...
**Current submission: FULL-v1** (`NORM-v2__BLK-v4b@20__FEAT-v2__MATCH-v2`, preset M-v3), stage-2
probabilities with the gated expected-F rule (gate 0.5).
...
| Run | Version key (folder name) | Eval universe | Eval F0.5 | Public leaderboard | md5 of `matching_results.tsv` |
|---|---|---|---:|---:|---|
| FULL-v1 | `NORM-v2__BLK-v4b@20__FEAT-v2__MATCH-v2` | full train | 0.9813 | 0.96 | `b4644450c78b5bf64f8124223223a005` |
| TLU-v1 | `NORM-v2__BLK-v4b@20-tlu40__FEAT-v3__MATCH-v6` | test-like | running | | |
| TLU-v2 | `NORM-v2__BLK-v4b@20-tlu40__FEAT-v4__MATCH-v6` | test-like | queued | | |
